...
**孙思邈中文医疗大模型**(简称: Sunsimiao)希望能够遵循孙思邈的生平轨迹, 重视民间医疗经验, 不断累积中文医疗数据, 并将数据附加给模型, 致力于提供**安全、可靠、普惠**的中文医疗大模型.  在医疗大模型评测榜单[CMB](https://cmedbenchmark.llmzoo.com/static/leaderboard.html)中孙思邈中文医疗大模型综合能力已**超越ChatGPT**。
...
| Sunsimiao-6B-05M | modelscope / huggingface | [modelscope](https://www.modelscope.cn/models/X-D-Lab/Sunsimiao-6B-05M/summary) / huggingface |
| Sunsimiao-InternLM-01M | modelscope / huggingface | [modelscope](https://www.modelscope.cn/models/X-D-Lab/Sunsimiao-InternLM-01M/summary) / huggingface |
| Sunsimiao-Qwen-7B | modelscope / huggingface | [modelscope](https://www.modelscope.cn/models/X-D-Lab/Sunsimiao-Qwen-7B/summary)/ huggingface |
...
| 主要分工 | 参与同学 |
| :----: | :---- |
| 模型训练 | [王明](https://github.com/w-sunmoon)、[颜鑫](https://github.com/thomas-yanxin) |
| 模型测试 | [唐井楠](https://github.com/jingnant)                        |
| 数据构建 |  |
