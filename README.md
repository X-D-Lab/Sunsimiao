...
特别感谢**浦语小助手**、**上海人工智能实验室推出的书生·浦语大模型实战营**([**InternLM-tutorial**](https://github.com/InternLM/tutorial)、[**InternStudio**](https://studio.intern-ai.org.cn/)、[**xtuner**](https://github.com/InternLM/xtuner))为我们的项目提供宝贵的技术指导和强大的算力支持！
